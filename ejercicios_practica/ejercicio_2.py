...
print('El valor almacenado e la variable numero_1 es:', numero_1)
print('El valor almacenado e la variable numero_2 es:', numero_2)
...
print("El resultado de sumar", numero_1, "y", numero_2, "es", sumar)
